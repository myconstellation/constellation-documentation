...
published: true
post_modified: 2017-05-05 17:34:43
---
...
Vous pouvez également passer plusieurs arguments à votre MC combinant type simple et type complexe. Si il y a plusieurs paramètres vous devez les stocker dans un tableau.
...
<p align="left">De ce fait pour réaliser un ping depuis une page Web :</p>

<pre class="lang:javascript decode:true">constellation.server.sendMessageWithSaga({ Scope: 'Package', Args: ['NetworkTools'] }, 'Ping', "www.google.fr",
    function(response) {
