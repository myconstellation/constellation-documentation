...
published: true
post_modified: 2016-12-31 16:30:09
---
L’interface REST “Consumer” permet de “consommer” c’est à dire :
<ul>
 	<li>Interroger des StateObjects (Request ou Subscribe)</li>
 	<li>Recevoir des messages</li>
...
Partons du principal que votre Constellation est exposée en HTTP sur le port 8088 (sans path) :
...
L’AccessKey doit bien sur être déclaré et activé sur le serveur.
...
<ul>
 	...
 	<li><u>args</u> : les argument du scope (par exemple le nom du groupe, de la sentinelle, du package ou de l’instance du package – plusieurs valeurs possible séparées par des virgules)</li>
...
La propriété “SagaId” dans le JSON ci-dessus est optionnel.
...
Ce même MessageCallback “SetTargetTemperature” du package Nest peut être invoquer dans une saga afin de recevoir un un accusé de réception :
...
Tout d’abord pour recevoir des messages il faut d’abord s’abonner
<ul>
...
<h4>Request</h4>
Cette méthode permet de récupérer la valeur actuel d’un ou de plusieurs StateObjects.
<ul>
...
<h4>Subscribe</h4>
Vous pouvez également vous abonnez aux mises à jour des StateObjects.
...
<pre>http://localhost:8088/rest/consumer/SubscribeStateObjects?SentinelName=Consumer&amp;PackageName=Demo&amp;AccessKey=MaCleDeTest123&amp;sentinel=MON-PC&amp;package=HWMonitor&amp;name=/intelcpu/load/0</pre>
...
<pre>http://localhost:8088/rest/consumer/SubscribeStateObjects?SentinelName=Consumer&amp;PackageName=Demo&amp;AccessKey=MaCleDeTest123&amp;sentinel=MON-PC&amp;package=HWMonitor&amp;name=/ram/load&amp;subscriptionId=&lt;subId&gt;</pre>
