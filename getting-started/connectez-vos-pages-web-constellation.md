...
published: true
post_modified: 2016-12-16 15:59:26
---
<h3>Introduction</h3>
...
Le client “Controller” permet lui de contrôler la Constellation pour par exemple récupérer en temps réel les logs produits par vos packages, arrêter/démarrer les packages, surveiller la consommation de ressources de chacun de vos packages, etc.

Dans ce “Hello World” nous allons afficher en temps réel la consommation de votre CPU dans une page Web en utilisant l’API Javascript. Pour cela vous devez avoir déployé le package “HWMonitor” sur au moins une de vos sentinelles.
...
De ce fait, vous pouvez créer une simple pages HTML et ajoutez les balises suivantes :
...
<p align="left">Créez ensuite une page Web (HTML ou ASPX) et dans l’entête de votre code HTML référencez les scripts (à adapter en fonction des n° de version des librairies contenus dans les packages Nuget) :</p>

<pre class="lang:html5 decode:true">&lt;script type="text/javascript" src="Scripts/jquery-1.6.4.min.js"&gt;&lt;/script&gt;
&lt;script type="text/javascript" src="Scripts/jquery.signalR-2.2.0.min.js"&gt;&lt;/script&gt;
&lt;script type="text/javascript" src="Scripts/Constellation-1.8.0.js"&gt;&lt;/script&gt;</pre>
...
<p align="left">Dans notre page HTML, créons un client “Consumer” en spécifiant l’URI de notre Constellayion, la clé d’accès utilisée pour se connecter et le “friendly name” de votre client :</p>
...
Lançons la page dans Chrome par exemple :
...
<p align="left">Vous remarquerez que dans le handler ci-dessus nous logguons également l’objet “stateobject” réceptionné par notre page.</p>
