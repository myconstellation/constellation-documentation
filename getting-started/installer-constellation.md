...
<ul>
 	...
 	<li>Pour installer le SDK : <strong>Visual Studio 2012, 2013, 2015 ou 2017</strong> (toutes éditions)</li>
</ul>
...
Pour gagner en productivité, vous avez à votre disposition le “<strong>Web Platform Installer</strong>”, un programme d’installation tout-en-un qui télécharge automatiquement les composants que vous souhaitez installer.
...
<p align="left">Vous pouvez sélectionner les composants à installer ou utiliser les profils prédéfinis :</p>
...
Notez que le programme vous indiques la dernière version de chaque composant à installer et est capable de déployer les mises à jour de chacun des composants.
...
<p align="left">Premièrement, vous devez sélectionner <a href="/licensing/">une licence</a> pour l’utilisation du serveur. Vous pouvez utiliser une licence que vous aurez préalablement téléchargé depuis le portail Constellation ou  vous connecter directement sur le service de licence de Constellation depuis l'installeur :</p>
...
Dans notre exemple, relançons le WPI. Comme le montre l'écran ci-dessous, tous les composants sont bien à jour mais vous pouvez encore ajouter la “Sentinel Service” sur cette machine :
